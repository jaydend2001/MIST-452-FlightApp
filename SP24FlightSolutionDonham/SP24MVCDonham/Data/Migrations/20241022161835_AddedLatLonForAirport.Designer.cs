...
namespace SP24MVCDonham.Data.Migrations
{
    ...
    [Migration("20241022161835_AddedLatLonForAirport")]
    partial class AddedLatLonForAirport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SP24ClassLibraryDonham.Ticket", b =>
                {
            ...
            modelBuilder.Entity("SP24ClassLibraryDonham.Ticket", b =>
                {
                    b.HasOne("SP24ClassLibraryDonham.AppUser", "AppUser")
                        .WithMany("Tickets")
                        .HasForeignKey("AppUserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SP24ClassLibraryDonham.Flight", "Flight")
                        .WithMany("Tickets")
